...
import { CreateMilitaryContributionRequest, MasterInquiryDetail, MilitaryContributionRequest, PagedReportResponse } from "reduxstore/types";
import { url } from "./api";
...
export const MilitaryApi = createApi({
    ...
    endpoints: (builder) => ({
        getMilitaryContributions: builder.query<
            PagedReportResponse<MasterInquiryDetail>,
