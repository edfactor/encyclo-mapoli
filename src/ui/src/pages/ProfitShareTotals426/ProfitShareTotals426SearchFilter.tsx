...
interface ProfitShareTotals426Search {
  profitYear: number;
}
...
interface ProfitShareTotals426SearchFilterProps {
  setInitialSearchLoaded: (include: boolean) => void;
}

const ProfitShareTotals426SearchFilter: React.FC<ProfitShareTotals426SearchFilterProps> = ({ setInitialSearchLoaded }) => {
  ...
  const {
    ...
    reset,
    trigger
  } = useForm<ProfitShareTotals426Search>({
...
export default ProfitShareTotals426SearchFilter; 