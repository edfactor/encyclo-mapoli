...
import { BeneficiaryKindDto, BeneficiaryRequestDto, BeneficiaryTypeDto, MasterInquiryRequest } from "reduxstore/types";
...
//   setMissiveAlerts
// }) => {
const BeneficiaryInquirySearchFilter: React.FC<Props> = ({ searchClicked, beneficiaryType, setInitialSearchLoaded, onSearch }) => {
