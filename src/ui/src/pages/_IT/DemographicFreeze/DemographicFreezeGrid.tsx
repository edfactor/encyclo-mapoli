...
import { GetDuplicateNamesAndBirthdayColumns } from "./DemographicFreezeGridColumns";
...
const DemographicFreeze: React.FC<DuplicateNamesAndBirthdaysGridSearchProps> = ({
  initialSearchLoaded,
