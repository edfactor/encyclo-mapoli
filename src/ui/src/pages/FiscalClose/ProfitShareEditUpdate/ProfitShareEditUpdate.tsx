...
const ProfitShareEditUpdate = () => {
  ...
  return (
    <PageErrorBoundary pageName="Profit Share Edit Update">
      <PrerequisiteGuard
                      ...
                      <TotalsGrid
                        displayData={[
                          ...
                          [
                            ...
                            numberToCurrency(
                              profitSharingUpdateAdjustmentSummary?.secondaryEarningsAmountAdjusted || 0
                            ),
                            numberToCurrency(
                              profitSharingUpdateAdjustmentSummary?.incomingForfeitureAmountAdjusted || 0
                            )
                          ]
                        ]}
