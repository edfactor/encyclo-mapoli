...
import { BaseDateRangeParams } from "reduxstore/types";
...
interface DateRangeSearchFilterProps {
  onSearch?: (data: BaseDateRangeParams) => void;
  isFetching?: boolean;
}

const EighteenToTwentySearchFilter: React.FC<DateRangeSearchFilterProps> = ({ onSearch, isFetching = false }) => {
  const {
    control,
    handleSubmit,
    formState: { errors, isValid },
    reset
  } = useForm<BaseDateRangeParams>({
...
export default EighteenToTwentySearchFilter;
