 ...
 */
export const findNavigationById = (
 ...
 */
export const containsActivePath = (
  items: NavigationDto[],
  pathname: string
): boolean => {
 ...
 */
export const getNavigationParentChain = (
  items: NavigationDto[] | undefined,
  id: number
): NavigationDto[] => {
  if (!items) return [];
 ...
 */
export const getNavigationLeafNodes = (
  items: NavigationDto[] | undefined
): NavigationDto[] => {
  if (!items) return [];
 ...
 */
export const getNavigationTreeDepth = (
  items: NavigationDto[] | undefined
): number => {
...
export const filterNavigationTree = (
  ...
  for (const item of items) {
    ...
    const filteredChildren = item.items 
      ? filterNavigationTree(item.items, predicate)
      : [];
 ...
 */
export const getNavigationByStatus = (
  items: NavigationDto[] | undefined,
  statusId: number
): NavigationDto[] => {
