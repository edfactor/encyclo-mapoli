...
export const CAPTIONS = {
  ...
  MANAGE_EXECUTIVE_HOURS: "Manage Executive Hours and Dollars (PROF-DOLLAR-EXEC-EXTRACT)",
  MASTER_INQUIRY: "Master Inquiry",
  MILITARY_ENTRY_AND_MODIFICATION: "Military Entry and Modification",
  MILITARY_CONTRIBUTIONS: "Military Contributions (TPR008-13)",
  REHIRE_FORFEITURES: "Rehire Forfeitures (QPREV-PROF)",
  ...
  PAY450: "PAY450",
  PAYMASTER_UPDATE: "Paymaster Update (PROF-UPD2)",
  ...
  PROFIT_SHARE_UPDATE: "Profit Share Updates (PAY444 PAY447 PAY460 PROFTLD)",
