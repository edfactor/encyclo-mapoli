...
SELECT
    ...
    TO_NUMBER(SUBSTR(LPAD(PYBEN_PSN,11,0),1,7)) AS EMPLOYEE_ID,
     CASE
...
LEFT join DEMOGRAPHIC d2 on TO_NUMBER(SUBSTR(LPAD(PYBEN_PSN,11,0),1,7)) = d2.EMPLOYEE_ID
...
inner join DEMOGRAPHIC d on d.EMPLOYEE_ID = PDR.PROFIT_DIST_REQ_EMP
LEFT JOIN
