...
VALUES(49,null, 'INQUIRIES', '','', 1, 1, '', 0);
--Sub values for INQUIRIES
INSERT INTO NAVIGATION(ID,PARENT_ID, TITLE, SUB_TITLE, URL, STATUS_ID, ORDER_NUMBER, ICON, DISABLED) 
VALUES(50,49, 'MASTER INQUIRY', '','master-inquiry', 1, 1, '', 0);
--Main menu
INSERT INTO NAVIGATION(ID,PARENT_ID, TITLE, SUB_TITLE, URL, STATUS_ID, ORDER_NUMBER, ICON, DISABLED) 
VALUES(51,null, 'BENEFICIARIES', '','', 1, 2, '', 1);
INSERT INTO NAVIGATION(ID,PARENT_ID, TITLE, SUB_TITLE, URL, STATUS_ID, ORDER_NUMBER, ICON, DISABLED) 
VALUES(52,null, 'DISTRIBUTIONS', '','', 1, 3, '', 1);
INSERT INTO NAVIGATION(ID,PARENT_ID, TITLE, SUB_TITLE, URL, STATUS_ID, ORDER_NUMBER, ICON, DISABLED) 
VALUES(53,null, 'RECONCILIATION', '','', 1, 4, '', 1);
INSERT INTO NAVIGATION(ID,PARENT_ID, TITLE, SUB_TITLE, URL, STATUS_ID, ORDER_NUMBER, ICON, DISABLED) 
VALUES(54,null, 'YEAR END', '','', 1, 5, '', 0);
INSERT INTO NAVIGATION(ID,PARENT_ID, TITLE, SUB_TITLE, URL, STATUS_ID, ORDER_NUMBER, ICON, DISABLED) 
VALUES(55,null, 'IT OPERATIONS', '','', 1, 6, '', 0);
--It Operations
INSERT INTO NAVIGATION(ID,PARENT_ID, TITLE, SUB_TITLE, URL, STATUS_ID, ORDER_NUMBER, ICON, DISABLED) 
VALUES(56,55, 'Demographic Freeze', '','demographic-freeze', 1, 1, '', 0);
...
INSERT INTO NAVIGATION(ID,PARENT_ID, TITLE, SUB_TITLE, URL, STATUS_ID, ORDER_NUMBER, ICON, DISABLED) 
VALUES(33,14, 'Reports by Age', '','', 1, 8, '', 0);
--sub values for Report by Age
INSERT INTO NAVIGATION(ID,PARENT_ID, TITLE, SUB_TITLE, URL, STATUS_ID, ORDER_NUMBER, ICON, DISABLED) 
VALUES(34,33, 'Get Contributions by Age', 'PROF130','contributions-by-age', 1, 1, '', 0);
INSERT INTO NAVIGATION(ID,PARENT_ID, TITLE, SUB_TITLE, URL, STATUS_ID, ORDER_NUMBER, ICON, DISABLED) 
VALUES(35,33, 'Get Distributions by Age', 'PROF130','distributions-by-age', 1, 2, '', 0);
INSERT INTO NAVIGATION(ID,PARENT_ID, TITLE, SUB_TITLE, URL, STATUS_ID, ORDER_NUMBER, ICON, DISABLED) 
VALUES(36,33, 'Get Forfeiture by Age', 'PROF130','forfeitures-by-age', 1, 3, '', 0);
INSERT INTO NAVIGATION(ID,PARENT_ID, TITLE, SUB_TITLE, URL, STATUS_ID, ORDER_NUMBER, ICON, DISABLED) 
VALUES(37,33, 'Get Balance by Age', 'PROF130B','balance-by-age', 1, 4, '', 0);
INSERT INTO NAVIGATION(ID,PARENT_ID, TITLE, SUB_TITLE, URL, STATUS_ID, ORDER_NUMBER, ICON, DISABLED) 
VALUES(38,33, 'Get Vested Amounts by Age', 'PROF130V','vested-amounts-by-age', 1, 5, '', 0);
INSERT INTO NAVIGATION(ID,PARENT_ID, TITLE, SUB_TITLE, URL, STATUS_ID, ORDER_NUMBER, ICON, DISABLED) 
VALUES(39,33, 'Get Balance by Years', 'PROF130Y','balance-by-years', 1, 6, '', 0);
--sub values for Fiscal Close
INSERT INTO NAVIGATION(ID,PARENT_ID, TITLE, SUB_TITLE, URL, STATUS_ID, ORDER_NUMBER, ICON, DISABLED) 
VALUES(40,14, 'Profit Share Gross Report', 'QPAY501','profit-share-gross-report', 1, 9, '', 0);
INSERT INTO NAVIGATION(ID,PARENT_ID, TITLE, SUB_TITLE, URL, STATUS_ID, ORDER_NUMBER, ICON, DISABLED) 
VALUES(41,14, 'Profit Share by Store', 'QPAY066TA','', 1, 9, '', 0);
--sub values of Profit Share by Store
INSERT INTO NAVIGATION(ID,PARENT_ID, TITLE, SUB_TITLE, URL, STATUS_ID, ORDER_NUMBER, ICON, DISABLED) 
VALUES(42,41, 'QPAY066-UNDR21', '','qpay066-under21', 1, 1, '', 0);
INSERT INTO NAVIGATION(ID,PARENT_ID, TITLE, SUB_TITLE, URL, STATUS_ID, ORDER_NUMBER, ICON, DISABLED) 
VALUES(43,41, 'QPAY066TA-UNDR21', '','qpay066ta-under21', 1, 2, '', 0);
INSERT INTO NAVIGATION(ID,PARENT_ID, TITLE, SUB_TITLE, URL, STATUS_ID, ORDER_NUMBER, ICON, DISABLED) 
VALUES(44,41, 'QPAY066TA', '','qpay066ta', 1, 3, '', 0);
INSERT INTO NAVIGATION(ID,PARENT_ID, TITLE, SUB_TITLE, URL, STATUS_ID, ORDER_NUMBER, ICON, DISABLED) 
VALUES(45,41, 'PROFALL Report', '','profall', 1, 4, '', 0);
INSERT INTO NAVIGATION(ID,PARENT_ID, TITLE, SUB_TITLE, URL, STATUS_ID, ORDER_NUMBER, ICON, DISABLED) 
VALUES(46,41, 'New Labels', 'QNEWPROFLBL','new-ps-labels', 1, 5, '', 0);
INSERT INTO NAVIGATION(ID,PARENT_ID, TITLE, SUB_TITLE, URL, STATUS_ID, ORDER_NUMBER, ICON, DISABLED) 
VALUES(47,41, 'PROFNEW', '','', 1, 6, '', 0);
--sub value for Fiscal Close
INSERT INTO NAVIGATION(ID,PARENT_ID, TITLE, SUB_TITLE, URL, STATUS_ID, ORDER_NUMBER, ICON, DISABLED) 
VALUES(48,14, 'Print Profit Certs', 'PAYCERT','', 1, 10, '', 0);
