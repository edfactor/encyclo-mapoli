...
DECLARE
    ...
    -- These are the third-level menus
    ...
    DISTRIBUTIONS_INQUIRY CONSTANT NUMBER := 103;
    MANAGE_EXECUTIVE_HOURS_PAGE CONSTANT NUMBER := 104;
    YTD_WAGES_EXTRACT CONSTANT NUMBER := 105;
    FORFEITURES CONSTANT NUMBER := 107;
    DISTRIBUTIONS_AND_FORFEITURES CONSTANT NUMBER := 108;
    PROFIT_SHARE_REPORT CONSTANT NUMBER := 109;
    GET_ELIGIBLE_EMPLOYEES CONSTANT NUMBER := 110;
    PROFIT_SHARE_FORFEIT CONSTANT NUMBER := 111;
    MASTER_UPDATE CONSTANT NUMBER := 112;
    PROFIT_MASTER_UPDATE CONSTANT NUMBER := 113;
    PAYMASTER_UPDATE CONSTANT NUMBER := 114;
    PROF_CONTROL_SHEET CONSTANT NUMBER := 115;
    PROF_SHARE_REPORT_BY_AGE CONSTANT NUMBER := 116;
    DISTRIBUTIONS_BY_AGE CONSTANT NUMBER := 117;
    CONTRIBUTIONS_BY_AGE CONSTANT NUMBER := 118;
    FORFEITURES_BY_AGE CONSTANT NUMBER := 119;
    BALANCE_BY_AGE CONSTANT NUMBER := 120;
    VESTED_AMOUNTS_BY_AGE CONSTANT NUMBER := 121;
    BALANCE_BY_YEARS CONSTANT NUMBER := 122;
    PROF_SHARE_GROSS_RPT CONSTANT NUMBER := 123;
    PROF_SHARE_BY_STORE CONSTANT NUMBER := 124;
    UNDER_21_REPORT CONSTANT NUMBER := 125;
    QPAY066_UNDR21 CONSTANT NUMBER := 126;
    QPAY066TA_UNDR21 CONSTANT NUMBER := 127;
    QPAY066B CONSTANT NUMBER := 128;
    QPAY066TA CONSTANT NUMBER := 129;
    QNEWPROFLBL CONSTANT NUMBER := 130;
    PROFNEW CONSTANT NUMBER := 131;
    PROFALL CONSTANT NUMBER := 132;
    REPRINT_CERTIFICATES CONSTANT NUMBER := 133;
    SAVE_PROF_PAYMSTR CONSTANT NUMBER := 134;
    QPAY066_AD_HOC_REPORTS CONSTANT NUMBER := 135;
    RECENTLY_TERMINATED CONSTANT NUMBER := 136;
    PAY_BENEFICIARY_REPORT CONSTANT NUMBER := 137;
    ...
    DEMOGRAPHIC_BADGES_NOT_IN_PAYPROFIT CONSTANT NUMBER := 145;
    DUPLICATE_SSNS_DEMOGRAPHICS CONSTANT NUMBER := 146;
    NEGATIVE_ETVA CONSTANT NUMBER := 147;
    TERMINATIONS CONSTANT NUMBER := 148;
...
--distribution items
    insert_navigation_item(DISTRIBUTIONS_INQUIRY, DISTRIBUTIONS_MENU, 'DISTRIBUTIONS INQUIRY', '', 'distributions-inquiry', STATUS_NORMAL, ORDER_FIRST, '', ENABLED, IS_NAVIGABLE);
...
-- Distribution Inquiry
    ...
    assign_navigation_role(DISTRIBUTIONS_INQUIRY, SYSTEM_ADMINISTRATOR);
    assign_navigation_role(DISTRIBUTIONS_INQUIRY, FINANCE_MANAGER);
    assign_navigation_role(DISTRIBUTIONS_INQUIRY, DISTRIBUTIONS_CLERK);
