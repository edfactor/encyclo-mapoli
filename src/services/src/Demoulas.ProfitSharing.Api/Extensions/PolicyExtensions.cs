...
internal static class PolicyExtensions
{
    internal static WebApplicationBuilder ConfigureSecurityPolicies(this WebApplicationBuilder builder)
    {
        ...
        _ = builder.Services.AddAuthorization(options =>
        {
            ...
            options.AddPolicy(Policy.CanFreezeDemographics, x => x.RequireRole(Role.ITOPERATIONS, Role.ADMINISTRATOR, Role.FINANCEMANAGER));
            ...
            options.AddPolicy(Policy.CanAccessItOperations, x => x.RequireRole(Role.ITOPERATIONS));
        });
