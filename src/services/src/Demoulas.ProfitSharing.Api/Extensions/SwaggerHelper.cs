...
internal static class SwaggerHelper
{
        ...
        Action<OktaSettings>? oktaSettingsAction = null)
    {
        ...
        OktaSettings oktaSettings = new OktaSettings { AuthorizationEndpoint = notSet, ClientId = notSet, Issuer = notSet, TokenEndpoint = notSet };
        oktaSettingsAction?.Invoke(oktaSettings);
                    ...
                    new OpenApiSecurityScheme
                    {
                        ...
                        Flows = new OpenApiOAuthFlows
                        {
                            AuthorizationCode = new OpenApiOAuthFlow
                            {
                                ...
                                {
                                    { "openid", "OpenID Connect scope" }, { "profile", "Profile scope" }, { "email", "Email scope" }
                                }
                            }
                        }
                    });
