...
public interface IMilitaryService
{
    ...
    Task<Result<PaginatedResponseDto<MilitaryContributionResponse>>> GetMilitaryServiceRecordAsync(GetMilitaryContributionRequest req, bool isArchiveRequest, CancellationToken cancellationToken = default);
}
