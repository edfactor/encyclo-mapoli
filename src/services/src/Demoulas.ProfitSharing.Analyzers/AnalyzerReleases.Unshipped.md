...
| DSM010  | Reliability       | Error    | CommentType.Name used in business logic - use Id instead (names are user-editable)    |
| DSM013  | API Documentation | Error    | Request/Response DTOs must have RequestExample() and ResponseExample() static methods |
