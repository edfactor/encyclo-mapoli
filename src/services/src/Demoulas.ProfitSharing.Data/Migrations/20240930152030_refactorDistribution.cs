...
{
    /// <inheritdoc />
    public partial class refactorDistribution : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.DropColumn(
                name: "THIRD_PARTY_STREET",
                table: "DISTRIBUTION");

            migrationBuilder.DropColumn(
                name: "THIRD_PARTY_STREET2",
                table: "DISTRIBUTION");

            migrationBuilder.DropColumn(
                name: "THIRD_PARTY_STREET3",
                table: "DISTRIBUTION");

            migrationBuilder.DropColumn(
                name: "THIRD_PARTY_STREET4",
                table: "DISTRIBUTION");

            migrationBuilder.RenameColumn(
                name: "SEQUENCE_NUMBER",
                table: "DISTRIBUTION",
                newName: "THIRD_PARTY_PAYEE_ID");

            migrationBuilder.RenameIndex(
                name: "IX_DISTRIBUTION_TAXCODEID",
                table: "DISTRIBUTION",
                newName: "IX_DISTRIBUTION_TAX_CODE_ID");
            ...
            migrationBuilder.AlterColumn<bool>(
                ...
                type: "NUMBER(1)",
                nullable: false,
                comment: "Qualified Domestic Relations Order",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NAME = table.Column<string>(type: "NVARCHAR2(35)", maxLength: 35, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ID = table.Column<int>(type: "NUMBER(10)", nullable: false)
                        .Annotation("Oracle:Identity", "START WITH 1 INCREMENT BY 1"),
                    SSN = table.Column<long>(type: "NUMBER(9)", precision: 9, nullable: false),
                    PAYEE = table.Column<string>(type: "NVARCHAR2(35)", maxLength: 35, nullable: true),
                    NAME = table.Column<string>(type: "NVARCHAR2(35)", maxLength: 35, nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DISTRIBUTION_THIRDPARTY_PAYEE_SSN",
                table: "DISTRIBUTION_THIRDPARTY_PAYEE",
                column: "SSN");
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.RenameIndex(
                ...
                table: "DISTRIBUTION",
                newName: "IX_DISTRIBUTION_TAXCODEID");
            ...
            migrationBuilder.AlterColumn<bool>(
                ...
                oldClrType: typeof(bool),
                oldType: "NUMBER(1)",
                oldComment: "Qualified Domestic Relations Order");
            ...
            migrationBuilder.AddPrimaryKey(
                name: "PK_DISTRIBUTION",
                table: "DISTRIBUTION",
                columns: new[] { "SSN", "SEQUENCE_NUMBER" });
