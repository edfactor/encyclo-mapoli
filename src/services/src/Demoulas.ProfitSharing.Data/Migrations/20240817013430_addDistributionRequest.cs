...
{
    /// <inheritdoc />
    public partial class addDistributionRequest : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DISTRIBUTION_REQUEST_DISTRIBUTION_REQUEST_REASON_REASONID",
                        column: x => x.REASON_ID,
                        principalTable: "DISTRIBUTION_REQUEST_REASON",
                        principalColumn: "ID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DISTRIBUTION_REQUEST_DISTRIBUTION_REQUEST_STATUS_STATUSID",
                        column: x => x.STATUS_ID,
                        principalTable: "DISTRIBUTION_REQUEST_STATUS",
                        principalColumn: "ID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DISTRIBUTION_REQUEST_DISTRIBUTION_REQUEST_TYPE_TYPEID",
                        column: x => x.TYPE_ID,
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { (byte)0, "HOME_PURCHASE" },
                    { (byte)1, "HOME_REPAIR" },
                    { (byte)2, "CAR" },
                    { (byte)3, "EDUCATION_EXP" },
                    { (byte)4, "FUNERAL_EXP" },
                    { (byte)5, "MEDICAL_DENTAL" },
                    { (byte)6, "EVICTION_OR_FORECLOSE" },
                    { (byte)7, "OTHER" }
                });
