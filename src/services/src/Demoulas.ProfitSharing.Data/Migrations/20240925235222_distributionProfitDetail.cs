...
{
    /// <inheritdoc />
    public partial class distributionProfitDetail : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_PROFIT_DETAIL_DISTRIBUTION_SSN_DISTRIBUTION_SEQUENCE",
                table: "PROFIT_DETAIL",
                columns: new[] { "SSN", "DISTRIBUTION_SEQUENCE" },
                principalTable: "DISTRIBUTION",
                principalColumns: new[] { "SSN", "SEQUENCE_NUMBER" });
        }
