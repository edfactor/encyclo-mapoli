...
{
    /// <inheritdoc />
    public partial class AddCommentTypeFieldToProfitDetail : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.DropColumn(
                name: "IS_TRANSFER_OUT",
                table: "PROFIT_DETAIL");

            migrationBuilder.RenameColumn(
                name: "TRANSFER_PSN",
                table: "PROFIT_DETAIL",
                newName: "COMMENT_RELATED_ORACLE_HCM_ID");

            migrationBuilder.AddColumn<bool>(
                name: "COMMENT_IS_PARTIAL_TRANSACTION",
                table: "PROFIT_DETAIL",
                type: "NUMBER(1)",
                nullable: true);
            ...
            migrationBuilder.AddColumn<short>(
                name: "COMMENT_RELATED_PSN_SUFFIX",
                table: "PROFIT_DETAIL",
                type: "NUMBER(5)",
                nullable: true);

            migrationBuilder.AddColumn<string>(
                name: "COMMENT_RELATED_STATE",
                table: "PROFIT_DETAIL",
                type: "NVARCHAR2(2000)",
                nullable: true);
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.RenameColumn(
                name: "COMMENT_RELATED_ORACLE_HCM_ID",
                table: "PROFIT_DETAIL",
                newName: "TRANSFER_PSN");
