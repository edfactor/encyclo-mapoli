...
public interface IOracleHcmCertificateService
{
    ...
    X509Certificate2 GetCertificate(string pfxFilePath, string? password);
    ...
    X509Certificate2 GetCertificateFromStream(Stream pfxStream, string? password, string? sourceIdentifier = null);
    ...
    X509Certificate2 GetCertificateFromBytes(byte[] pfxData, string? password, string? sourceIdentifier = null);    /// <summary>
