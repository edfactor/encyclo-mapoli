...
public class GetFrozenDemographicsEndpoint : EndpointWithoutRequest<List<SetFrozenStateResponse>>
{
    ...
    public override Task<List<SetFrozenStateResponse>> ExecuteAsync(CancellationToken ct)
    {
