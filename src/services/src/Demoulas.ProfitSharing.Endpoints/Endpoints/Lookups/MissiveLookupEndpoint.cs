...
public sealed class MissiveLookupEndpoint : ProfitSharingResultResponseEndpoint<ListResponseDto<MissiveResponse>>
{
    ...
    public MissiveLookupEndpoint(IMissiveService missiveService, ILogger<MissiveLookupEndpoint> logger)
            ...
            {
                {
                    200, new List<MissiveResponse>
                    {
                        new MissiveResponse
                        {
                            ...
                            Message = "***Vesting Increased***",
                            Description = "More descriptive text explaining the warning",
                            Severity = "Error"
                        }
                    }
                }
    ...
    protected override async Task<Results<Ok<ListResponseDto<MissiveResponse>>, NotFound, ProblemHttpResult>> HandleRequestAsync(CancellationToken ct)
    {
        ...
        try
        {
            ...
            EndpointTelemetry.BusinessOperationsTotal.Add(1,
                ...
                new("endpoint", nameof(MissiveLookupEndpoint)));
