...
public class GetNavigationStatusEndpoint : ProfitSharingEndpoint<GetNavigationStatusRequestDto, Results<Ok<GetNavigationStatusResponseDto>, NotFound, ProblemHttpResult>>
{
    ...
    protected override async Task<Results<Ok<GetNavigationStatusResponseDto>, NotFound, ProblemHttpResult>> HandleRequestAsync(GetNavigationStatusRequestDto req, CancellationToken ct)
    {
