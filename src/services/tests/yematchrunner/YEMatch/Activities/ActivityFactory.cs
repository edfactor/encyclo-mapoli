...
public sealed class ActivityFactory : IActivityFactory
{
    ...
    private static ActivityName MapStringToEnum(string name)
    {
        ...
        {
            // READY activities
            "R0" => ActivityName.R00_BuildDatabase,
            "R1" => ActivityName.R01_CleanUpReports,
            "R2" => ActivityName.R02_MilitaryAndRehire,
            "R3" => ActivityName.R03_ProfTermination,
            "R4" => ActivityName.R04_ProfShareLoanBalance,
            "R5" => ActivityName.R05_ExtractExecutiveHoursAndDollars,
            "R6" => ActivityName.R06_ClearExecutiveHoursAndDollars,
            "R7" => ActivityName.R07_ReadyScreen00809,
            "R8" => ActivityName.R08_ProfitShareReport,
            "R9" => ActivityName.R09_YEOraclePayrollProcessing,
            ...
            // SMART activities
            "S0" => ActivityName.S00_InitializeDatabase,
            "S1" => ActivityName.S01_CleanUpReports,
            "S2" => ActivityName.S02_MilitaryAndRehire,
            "S3" => ActivityName.S03_ProfTermination,
            "S4" => ActivityName.S04_ProfShareLoanBalance,
            "S5" => ActivityName.S05_ExtractExecutiveHoursAndDollars,
            "S6" => ActivityName.S06_ClearExecutiveHoursAndDollars,
            "S7" => ActivityName.S07_ReadyScreen00809,
            "S8" => ActivityName.S08_ProfitShareReport,
            "S9" => ActivityName.S09_YEOraclePayrollProcessing,
            ...
            // Parallel activities
            "P0" => ActivityName.P00_BuildDatabase,
            "P1" => ActivityName.P01_CleanUpReports,
            "P2" => ActivityName.P02_MilitaryAndRehire,
            "P3" => ActivityName.P03_ProfTermination,
            "P4" => ActivityName.P04_ProfShareLoanBalance,
            "P5" => ActivityName.P05_ExtractExecutiveHoursAndDollars,
            "P6" => ActivityName.P06_ClearExecutiveHoursAndDollars,
            "P7" => ActivityName.P07_ReadyScreen00809,
            "P8" => ActivityName.P08_ProfitShareReport,
            "P9" => ActivityName.P09_YEOraclePayrollProcessing,
