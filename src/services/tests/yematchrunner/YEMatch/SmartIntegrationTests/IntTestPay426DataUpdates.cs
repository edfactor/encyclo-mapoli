...
public class IntTestPay426DataUpdates : BaseActivity
{
    public override async Task<Outcome> Execute()
    {
        ...
        var args =
            "dotnet test --filter FullyQualifiedName~TestPay426DataUpdates";
        ...
        return new Outcome(
            ActivityLetterNumber: "TestPay426DataUpdates",
            Name: "Integration Test TestPay426DataUpdates",
