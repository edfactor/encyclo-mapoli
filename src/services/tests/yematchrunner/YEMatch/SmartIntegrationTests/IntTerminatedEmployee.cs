...
public class IntTerminatedEmployee : BaseActivity
{
    public override async Task<Outcome> Execute()
    {
        ...
        var args =
            "dotnet test --filter FullyQualifiedName~TerminatedEmployeeAndBeneficiaryReportIntegrationTests";
        ...
        return new Outcome(
            ActivityLetterNumber: "TerminatedEmployee",
