...
public static class ReadyActivityFactory
{
    ...
    public static List<IActivity> CreateActivities(string dataDirectory)
    {
        ...
        [
            ...
            new ReadyActivity(sshClient, SftpClient, chatty, "A2", "TERM-REHIRE", "BDATE=240106 EDATE=250104", dataDirectory),
            new ReadyActivity(sshClient, SftpClient, chatty, "A3", "PROF-TERM", "SDATE=240106 EDATE=250104 YDATE=2024", dataDirectory),
            ...
            new ReadyActivity(sshClient, SftpClient, chatty, "A8", "PROF-SHARE", "sw[3]=1 CDATE=250104 SUMREP=Y YEAREND=N", dataDirectory),
            ...
            new ReadyActivity(sshClient, SftpClient, chatty, "A17", "PROF-SHARE", "sw[3]=1 sw[2]=1 CDATE=250104 YEAREND=Y SUMREP=Y", dataDirectory),
            new ReadyActivity(sshClient, SftpClient, chatty, "A18", "PROF-SHARE", "sw[2]=1 CDATE=250104 YEAREND=Y", dataDirectory),
            ...
            new ReadyActivity(sshClient, SftpClient, chatty, "A25", "PROFSHARE-RPT", "CDATE=250104", dataDirectory),
            new ReadyActivity(sshClient, SftpClient, chatty, "A26", "PROFGROSS", "YDATE=2024 GROSS=50000", dataDirectory),

            // Post-Frozen
            new ReadyActivity(sshClient, SftpClient, chatty, "A27", "PROF-BREAK", "FILEONLY=N FRSTDATE=240106 LASTDATE=250104 YDATE=2024 LBLOPT=NO", dataDirectory),
            new ReadyActivity(sshClient, SftpClient, chatty, "A28", "PROF-CERT01", "YDATE=2024 LASTDATE=250104 FRSTDATE=240106", dataDirectory),
