...
public class ReversalBeneficiaryTests : ApiTestBase<Program>
{
    ...
    public ReversalBeneficiaryTests()
    {
    ...
    public async Task ensure_beneficiary_happy_path()
    {
        ...
        // Assert
        response.BeneficiariesReverted.Should().Be(1);
        response.EmployeesReverted.Should().Be(0);
