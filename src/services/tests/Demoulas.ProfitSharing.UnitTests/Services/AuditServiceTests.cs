...
/// <summary>
/// Unit tests for ProfitSharingProfitSharingAuditService.ToKeyValuePairs method to verify all primitive numeric types
...
public sealed class AuditServiceTests
{
    ...
    public void ToKeyValuePairs_WithExplicitAttributes_ShouldArchiveAllAttributedNumericTypes()
    {
        ...
        // Act
        var result = ProfitSharingProfitSharingAuditService.ToKeyValuePairs(testObj, new List<Func<ExplicitAttributeTestClass, (string, object)>>()).ToList();
    ...
    public void ToKeyValuePairs_WithClassAttribute_ShouldArchiveAllNumericProperties()
    {
        ...
        // Act
        var result = ProfitSharingProfitSharingAuditService.ToKeyValuePairs(testObj, new List<Func<ClassAttributeTestClass, (string, object)>>()).ToList();
    ...
    public void ToKeyValuePairs_WithReportResponse_ShouldArchiveAllMarkedFields()
    {
        ...
        // Act
        var result = ProfitSharingProfitSharingAuditService.ToKeyValuePairs(testObj, new List<Func<ReportResponseTestClass, (string, object)>>()).ToList();
    ...
    public void ToKeyValuePairs_WithSameValue_ShouldProduceSameHash()
    {
        ...
        // Act
        var result1 = ProfitSharingProfitSharingAuditService.ToKeyValuePairs(testObj1, new List<Func<ReportResponseTestClass, (string, object)>>()).ToList();
        var result2 = ProfitSharingProfitSharingAuditService.ToKeyValuePairs(testObj2, new List<Func<ReportResponseTestClass, (string, object)>>()).ToList();
    ...
    public void ToKeyValuePairs_WithNoAttributedProperties_ShouldReturnEmptyCollection()
    {
        ...
        // Act
        var result = ProfitSharingProfitSharingAuditService.ToKeyValuePairs(testObj, new List<Func<object, (string, object)>>()).ToList();
