...
public sealed class AuditServiceTests
{
    ...
    public void ToKeyValuePairs_WithExplicitAttributes_ShouldArchiveAllAttributedNumericTypes()
    {
        ...
        // Act
        var result = ProfitSharingProfitSharingAuditService.ToKeyValuePairs(testObj, []).ToList();
    ...
    public void ToKeyValuePairs_WithSameValue_ShouldProduceSameHash()
    {
        ...
        // Act
        var result1 = ProfitSharingProfitSharingAuditService.ToKeyValuePairs(testObj1, []).ToList();
        var result2 = ProfitSharingProfitSharingAuditService.ToKeyValuePairs(testObj2, []).ToList();
