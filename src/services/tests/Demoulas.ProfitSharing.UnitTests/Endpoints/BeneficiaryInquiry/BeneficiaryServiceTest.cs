...
public class BeneficiaryServiceTest : ApiTestBase<Program>
{
    ...
    {
        var res = await _beneficiaryService.GetBeneficiaryAsync(new BeneficiaryRequestDto() { BadgeNumber = 703244 }, CancellationToken.None);
        Assert.NotNull(res);
    ...
    {
        var res = await _beneficiaryService.GetBeneficiaryDetailAsync(new BeneficiaryDetailRequest() { BadgeNumber = 703244, PsnSuffix = 1000 }, CancellationToken.None);
        Assert.NotNull(res);
    ...
    {
        var res = await _beneficiaryService.BeneficiarySearchFilterAsync(new BeneficiarySearchFilterRequest() { MemberType = 2, BadgeNumber = 703244, PsnSuffix = 1000 }, CancellationToken.None);
        Assert.NotNull(res);
