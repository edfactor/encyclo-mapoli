...
public class UpdateSummaryTests : PristineBaseTest
{
    ...
    {
        _frozenReportService = new FrozenReportService(DbFactory, new LoggerFactory(), new ContributionService(DbFactory, DemographicReaderService), TotalService, CalendarService,
