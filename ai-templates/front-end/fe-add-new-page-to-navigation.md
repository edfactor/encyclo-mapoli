...
Eitehr way, add a new constant with the name of the page to the list of constants that begin on line 100. It's value will be a number greater than 100. Use the next available number.
