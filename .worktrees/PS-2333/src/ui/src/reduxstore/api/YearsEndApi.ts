...
type UpdateSummaryRequestWithArchive = UpdateSummaryRequest & {
  archive?: boolean;
};
...
export const YearsEndApi = createApi({
  ...
  endpoints: (builder) => ({
    ...
    getDuplicateSSNs: builder.query<
      PagedReportResponse<DuplicateSSNDetail>,
      DuplicateSSNsRequestDto
    >({
      query: (params) => ({
    ...
    getGrossWagesReport: builder.query<
      GrossWagesReportResponse,
      GrossWagesReportDto
    >({
      query: (params) => ({
    ...
    getUnForfeits: builder.query<
      PagedReportResponse<UnForfeit>,
    ...
    >({
      query: (params) => ({
        ...
        params: {
          profitYear: params.profitYear,
          useFrozenData:
            params.useFrozenData !== undefined ? params.useFrozenData : true,
          take: params.pagination.take,
          skip: params.pagination.skip,
          sortBy: params.pagination.sortBy,
          isSortDescending: params.pagination.isSortDescending,
      ...
      transformResponse: (
        ...
        if (
          ...
          return {
            ...
            totalIncomeCurrentYearWages:
              firstResult.totalIncomeCurrentYearWages,
            response: {
              ...response.response,
    ...
    >({
      ...
      async onQueryStarted(
        _params: EligibleEmployeesRequestDto,
    ...
    getDistributionsByAge: builder.query<
      ProfitSharingDistributionsByAge,
      FrozenReportsByAgeRequest
    >({
      query: (params) => ({
    ...
    getContributionsByAge: builder.query<
      ContributionsByAge,
      FrozenReportsByAgeRequest
    >({
      query: (arg) => {
    ...
    getForfeituresByAge: builder.query<
      ForfeituresByAge,
      FrozenReportsByAgeRequest
    >({
      query: (params) => ({
    ...
    >({
      query: (params) => {
        const { suppressAllToastErrors, onlyNetworkToastErrors, archive } =
          params;
        return {
    ...
    getVestingAmountByAge: builder.query<
      VestedAmountsByAge,
      ProfitYearRequest & { acceptHeader: string }
    >({
      query: (params) => ({
    ...
    getTerminationReport: builder.query<
      TerminationResponse,
      TerminationRequestWithArchive
    >({
      query: (params) => {
        const body: {
        ...
        if (
          params.vestedBalanceValue !== null &&
          params.vestedBalanceValue !== undefined
        ) {
          body.vestedBalanceValue = params.vestedBalanceValue;
        }

        if (
          params.vestedBalanceOperator !== null &&
          params.vestedBalanceOperator !== undefined
        ) {
        ...
        return {
          url: `yearend/terminated-employees${
            params.archive === true ? "?archive=true" : ""
          }`,
          method: "POST",
          body,
        };
    ...
    getProfitShareUpdate: builder.query<
      ProfitShareUpdateResponse,
      ProfitShareUpdateRequest
    >({
      query: (params) => ({
      ...
      async onQueryStarted(arg, { dispatch, queryFulfilled }) {
        try {
          ...
          dispatch(
            setProfitSharingUpdateAdjustmentSummary(data.adjustmentsSummary)
          );
          if (arg.badgeToAdjust) {
            //console.log("Added badge: " + arg.badgeToAdjust);
            dispatch(
              addBadgeNumberToUpdateAdjustmentSummary(arg.badgeToAdjust)
            );
          }
        } catch (err) {
          console.log("Err", err);
    ...
    getProfitShareEdit: builder.query<
      ProfitShareEditResponse,
      ProfitShareUpdateRequest
    >({
      query: (params) => ({
    ...
    getUnder21BreakdownByStore: builder.query<
      Under21BreakdownByStoreResponse,
      Under21BreakdownByStoreRequest
    >({
      query: (params) => ({
    ...
    getPostFrozenUnder21: builder.query<
      ProfitSharingUnder21ReportResponse,
      ProfitSharingUnder21ReportRequest
    >({
      query: (params) => ({
    ...
    getUnder21Inactive: builder.query<
      Under21InactiveResponse,
      Under21InactiveRequest
    >({
      query: (params) => ({
    ...
    getUnder21Totals: builder.query<
      Under21TotalsResponse,
      Under21TotalsRequest
    >({
      query: (params) => ({
    ...
    getMasterApply: builder.mutation<
      ProfitShareMasterResponse,
      ProfitShareMasterApplyRequest
    >({
      query: (params) => ({
    ...
    getProfitSharingLabels: builder.query<
      Paged<ProfitSharingLabel>,
      ProfitSharingLabelsRequest
    >({
      query: (params) => ({
    ...
    >({
      query: (params) => ({
        url: `yearend/yearend-profit-sharing-report-totals${
          params.archive === true ? "/?archive=true" : ""
        }`,
        method: "POST",
        body: {
    ...
    getUpdateSummary: builder.query<
      UpdateSummaryResponse,
      UpdateSummaryRequestWithArchive
    >({
      query: (params) => ({
    ...
    getCertificatesReport: builder.query<
      CertificatesReportResponse,
      CertificatePrintRequest
    >({
      query: (params) => ({
